...
from apps.info.tools import update_currency, update_covid
from tools.add_rnd import create_brands_and_vendors, create_random_goods, create_vendors_and_offers
