...
from apps.info.views import TodayExchangeCurrencyViewSet, CovidViewSet
from apps.store.views import VendorViewSet, BasketViewSet, CategoryViewSet, ProductViewSet, BrandViewSet, OrderViewSet, \
